...
rent_map = {1:[4,10,30,90,160,250], 3:[8,20,60,180,320,450],
            ...
            26:[44,110,330,800,975,1150], 27:[44,110,330,800,975,1150], 29:[48,120,360,850,1025,1200],
...
cost_map = {1:[60,50], 3:[60,50],
            ...
            26:[260,150], 27:[260,150], 29:[280,150],
            31:[300,200], 32:[300,200], 34:[320,200],
            37:[350,200], 39:[400,200]}

def get_points(color: str, house_count: int = 0, dpd = dpd):
